...
size = os.path.getsize('device_list_s1.txt')



with open('device_list_s1.txt', 'r') as f:
...
myCmd = r'sudo lsusb > /home/pi/Desktop/device_test_s1/'+Device_name+'_USB.txt'
os.system(myCmd)
...
with open('device_list_s1.txt', 'a') as f:
    f.writelines('\n')
